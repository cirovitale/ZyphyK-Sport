...
public class OrdersDAOTest extends DataSourceBasedDBTestCase{
    ...
    public void testDoRetrieveAllOrders() throws SQLException {
    	...
    	OrdersBean orders1 = new OrdersBean(1, "daniPicci", " ", LocalDateTime.of(2022,11,23,12,45,0), "Via Roma 221 Salerno SA", "5333171120934758 09/27 432", 294);
    	...
    	OrdersBean orders4 = new OrdersBean(4, "peppeRoma", " ", LocalDateTime.of(2022,9,23,21,34,0), "Via De Goti 78 Caserta CE", "3324558912349076 04/26 278", 439);
    	OrdersBean orders5 = new OrdersBean(5, "angeloPorte", " ", LocalDateTime.of(2023,1,12,19,8,0), "Via Misano 221 Milano MI", "1234789467387462 06/25 475", 247);
    ...
    public void testDoSaveOrders() throws Exception{
    	...
    	ordersDAO.doSave("daniPicci", null, LocalDateTime.of(2022,11,23,12,45,0), "Via Roma 221 Salerno SA", "5333171120934758 09/27 432", 294, false);
    	ordersDAO.doSave("marioRossi", "LuBacco", LocalDateTime.of(2023,5,11,18,23,0), "Via Casa Varone 113 Eboli SA", "5333171121903456 11/26 782", 252, true);
    	ordersDAO.doSave("daniPicci", "LuBacco", LocalDateTime.of(2022,1,30,22,47,0), "Via Stabia 36 Pompei NA", "6734536271823456 12/25 934", 321, true);
    	ordersDAO.doSave("peppeRoma", null, LocalDateTime.of(2022,9,23,21,34,0), "Via De Goti 78 Caserta CE", "3324558912349076 04/26 278", 439, false);
    	ordersDAO.doSave("angeloPorte", null, LocalDateTime.of(2023,1,12,19,8,0), "Via Misano 221 Milano MI", "1234789467387462 06/25 475", 247, false);
