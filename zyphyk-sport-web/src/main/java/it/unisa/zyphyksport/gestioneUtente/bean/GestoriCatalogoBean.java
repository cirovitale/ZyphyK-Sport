...
public class GestoriCatalogoBean implements Serializable{
	...
	public String toString() {
		return "GestoriCatalogoBean [username=" + username + ", name=" + name + ", surname=" + surname + ", email="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GestoriCatalogoBean other = (GestoriCatalogoBean) obj;
